  ...
  <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center' }}>
          <input
            ...
            style={{ flex: '1', marginRight: '10px', padding: '8px', borderRadius: '5px', border: '2px solid #0fa3b1'}}
            placeholder="Type your message here..."
          />
          <button onClick={handleSendMessage} style={{ padding: '8px', borderRadius: '50%', backgroundColor: '#0fa3b1', color: '', border: 'none', cursor: 'pointer' }}>
